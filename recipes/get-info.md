# Recipe: get YouTube video metadata (no download)
...
download quota. Use it any time the user asks a question about a video rather
than asking you to download it, or when you need to decide on a `quality`
before calling `download_video`.
...
2. If `license` is `"Creative Commons"`, you can comfortably download on
   behalf of users who plan to redistribute.
